...
_DEFAULT_RUBRIC_ITEMS: list[dict] = [
    ...
    {"category": "performance", "item_key": "executed",   "label": "Executed",
     "weight": None, "description": "SQL runs against the database without raising an error",                               "position": 1},
    {"category": "performance", "item_key": "time_ok",    "label": "Time OK",
     "weight": None, "description": "Total time (LLM generation + DB execution) is under the configured ms threshold",    "position": 2},
    {"category": "performance", "item_key": "rows_ok",    "label": "Rows OK",
     "weight": None, "description": "Actual row count matches the expected row count for the query",                       "position": 3},
    {"category": "performance", "item_key": "pass",       "label": "Pass",
     "weight": None, "description": "All three checks above are true",                                                     "position": 4},
]
...
SEED_TEST_CASES = [
    ...
    {"category": "performance", "question": "Which product generated the most revenue?",
     "expected_rows": 7, "time_threshold_ms": 6000.0},
    ...
    {"category": "performance", "question": "Which sales manager generated the most revenue through their team?",
     "expected_rows": 6, "time_threshold_ms": 3500.0},
    ...
    {"category": "performance", "question": "Which accounts have the highest total interaction count?",
     "expected_rows": 10, "time_threshold_ms": 3000.0},
